...
final class LoginTests: XCTestCase {
    ...
    func testLoginHappyPath() throws {
        ...
        let user = try UserModel(fullName: "Test User", email: "test@test.com", passwordHash: app.password.hash("password"), isEmailVerified: true)
    ...
    func testLoginWithIncorrectPasswordFails() throws {
        app.passwords.use(.plaintext)
        let user = UserModel(fullName: "Test User", email: "test@test.com", passwordHash: "password", isEmailVerified: true)
        try app.repositories.users.create(user).wait()
    ...
    func testLoginRequiresEmailVerification() throws {
        ...
        let user = UserModel(fullName: "Test User", email: "test@test.com", passwordHash: "password", isEmailVerified: false)
        try app.repositories.users.create(user).wait()
