//
//  PasswordTokenRepositoryTests.swift
//  
//
...
final class PasswordTokenRepositoryTests: XCTestCase {
    var app: Application!
    var repository: PasswordTokenRepositoryProtocol!
    var user: UserModel!
    ...
    override func setUpWithError() throws {
        ...
        user = UserModel(fullName: "Test User", email: "test@test.com", passwordHash: "123")
