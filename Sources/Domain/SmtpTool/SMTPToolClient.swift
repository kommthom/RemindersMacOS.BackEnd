...
public struct SMTPToolClient: SMTPProviderProtocol {
    ...
    public func send(_ email: Email, logHandler: ((String) -> Void)? = nil) async throws {
    ...
    public func delegating(to eventLoop: EventLoop) -> SMTPProviderProtocol {
