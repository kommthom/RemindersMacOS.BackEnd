//
//  String+htmlEscape+htmlUnescape.swift
//
//
...
public func stringHtmlEscape(stringToEscape: String) -> String {
    stringToEscape.htmlEscape()
}

public func stringHtmlUnescape(stringToUnescape: String) throws -> String {
    try stringToUnescape.htmlUnescape(strict: true)
}
...
public extension String {
    ...
    func htmlEscape(allowUnsafeSymbols: Bool = false,
                           decimal: Bool = false,
                           encodeEverything: Bool = false,
                           useNamedReferences: Bool = false)
        -> String {
            // result buffer
            var str: String = ""
            let characters = self
