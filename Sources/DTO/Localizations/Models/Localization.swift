...
public enum Localization {
    ...
    public func value(forLocale locale: Localizations.LocalizationIdentifier, interpolations: [String: Any]? = nil) -> String {
        switch self {
...
private extension Localization {
    ...
    func pluralCategory(`for` locale: Localizations.LocalizationIdentifier, interpolations: [String: Any]?) -> PluralCategory {
